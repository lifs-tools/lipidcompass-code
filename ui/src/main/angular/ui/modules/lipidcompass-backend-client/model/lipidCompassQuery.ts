...
export interface LipidCompassQuery { 
    lipidLevel: LipidCompassQuery.LipidLevelEnum;
    names: Array<string>;
    matchMode: LipidCompassQuery.MatchModeEnum;
...
export namespace LipidCompassQuery {
