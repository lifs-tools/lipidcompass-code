...
export interface EntityModelLipid { 
    id?: string;
    arangoId?: string;
    transactionUuid: string;
    visibility?: EntityModelLipid.VisibilityEnum;
    nativeUrl?: string;
    commonName?: string;
    normalizedShorthandName?: string;
    lipidLevel?: EntityModelLipid.LipidLevelEnum;
...
export namespace EntityModelLipid {
