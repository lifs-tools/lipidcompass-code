...
export interface LipidMapsEntryAllOf { 
    id?: string;
    arangoId?: string;
    transactionUuid?: string;
    visibility?: LipidMapsEntryAllOf.VisibilityEnum;
    ...
    nativeId?: string;
    nativeUrl?: string;
    level?: LipidMapsEntryAllOf.LevelEnum;
    goslinLevel?: LipidMapsEntryAllOf.GoslinLevelEnum;
...
export namespace LipidMapsEntryAllOf {
