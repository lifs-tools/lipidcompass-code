...
export interface SwissLipidsEntry { 
    ...
    visibility?: SwissLipidsEntry.VisibilityEnum;
    revision?: string;
    dateCreated?: string;
    ...
    abbreviation?: string;
    description?: string;
    level?: SwissLipidsEntry.LevelEnum;
    goslinLevel?: SwissLipidsEntry.GoslinLevelEnum;
...
export namespace SwissLipidsEntry {
