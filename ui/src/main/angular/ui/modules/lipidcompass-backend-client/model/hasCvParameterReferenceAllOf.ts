...
export interface HasCvParameterReferenceAllOf { 
    id?: string;
    arangoId?: string;
    transactionUuid?: string;
    visibility?: HasCvParameterReferenceAllOf.VisibilityEnum;
    from?: ArangoBaseEntity;
    to?: CvParameter;
    revision?: string;
    dateCreated?: string;
...
export namespace HasCvParameterReferenceAllOf {
