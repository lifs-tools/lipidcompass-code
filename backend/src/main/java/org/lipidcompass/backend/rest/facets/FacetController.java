 ...
 */
package org.lipidcompass.backend.rest.facets;
...
public class FacetController extends AbstractArangoController<LipidQuantity, LipidQuantityRepository> {

    @Autowired
    public FacetController(LipidQuantityRepository repository,
...
//    }
    ...
    public ResponseEntity<CollectionModel<EntityModel<MzTabResultsForLipid>>> findMzTabResultsForLipid(@PathVariable String lipidId) {
        ...
        List<MzTabResultsForLipid> p = repository.findMzTabResultsForLipid(lipidId);
