...
import org.lipidcompass.service.core.io.MinioProperties;
...
public class MinioConfiguration {
    ...
    public MinioClient minioClient() {
        log.debug("Received minio properties: {}", minioProperties);
    ...
    public MinioStorageService minioStorageService() {
        return new MinioStorageService(minioClient(), minioProperties);
    }
