...
public class OpenApiConfiguration {
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                ...
                .info(new Info().title("LipidCompass Backend API").version(apiVersion).description("Documentation for LipidCompass Backend API v1.0"))
                .addSecurityItem(
    ...
    public OperationCustomizer operationIdCustomizer() {
        return (operation, handlerMethod) -> {
            ...
            if (Objects.nonNull(superClazz) && superClazz.isAssignableFrom(AbstractArangoController.class)) {
