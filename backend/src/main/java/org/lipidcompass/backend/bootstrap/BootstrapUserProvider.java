 ...
 */
@Component
public class BootstrapUserProvider {

    public void setSecurityContextUser(String userName, GrantedAuthority... grantedAuthorities) {
    ...
    public void clearSecurityContextUser() {
