 ...
 */
@Slf4j
public class LipidMapsEntrySerializer extends StdSerializer<LipidMapsEntry> {

    public LipidMapsEntrySerializer() {
        this(null);
    }

    public LipidMapsEntrySerializer(Class<LipidMapsEntry> t) {
        super(t);
    }

    @Override
    public void serialize(
            LipidMapsEntry value, JsonGenerator jgen, SerializerProvider provider)
        ...
        try {
            ...
            jgen.writeStringField("lmClassificationCode", value.getLmClassificationCode());
            jgen.writeStringField("lipidMapsCategory", value.getLipidMapsCategory());
            jgen.writeStringField("lipidMapsMainClass", value.getLipidMapsMainClass());
            if (value.getLevel() == null) {
                jgen.writeStringField("level", null);
            } else {
                jgen.writeStringField("level", value.getLevel().name());
            }
            if (value.getGoslinLevel() == null) {
                jgen.writeStringField("goslinLevel", null);
            } else {
                jgen.writeStringField("goslinLevel", value.getGoslinLevel().name());
            }
