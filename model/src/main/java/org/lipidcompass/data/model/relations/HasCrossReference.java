...
@Edge("hasCrossReference")
@EqualsAndHashCode(onlyExplicitlyIncluded = true, callSuper = true)
@NoArgsConstructor(access = AccessLevel.PRIVATE)
@SuperBuilder
public class HasCrossReference extends ArangoBaseEdge<Lipid, CrossReference> {

    public HasCrossReference(Lipid lipid, CrossReference crossReference, String transactionUuid, Visibility visibility) {
        super(lipid, crossReference, transactionUuid, visibility);
    }
