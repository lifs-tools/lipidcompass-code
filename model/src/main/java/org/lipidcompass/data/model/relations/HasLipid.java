...
@SuperBuilder
public class HasLipid extends ArangoBaseEdge<Lipidome, Lipid> {

    public HasLipid(Lipidome lipidome, Lipid lipid, String transactionUuid, Visibility visibility) {
        super(lipidome, lipid, transactionUuid, visibility);
    }
