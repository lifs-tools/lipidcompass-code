...
//@SuperBuilder
public class HasFattyAcyl extends ArangoBaseEdge<Lipid, FattyAcyl> {

    @Builder
    public HasFattyAcyl(Lipid from, FattyAcyl to, String transactionUuid, Visibility visibility) {
